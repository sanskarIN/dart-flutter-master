...
This directory is for reusable, focused Dart/Flutter examples that are useful across multiple parts.

Every example should state:

- what it demonstrates
- required Dart/Flutter version or packages when relevant
- how to run it
